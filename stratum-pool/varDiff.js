...
var varDiff = module.exports = function varDiff(port, varDiffOptions){
    ...
    this.manageClient = function(client){
        ...
        client.on('submit', function(){
            ...
            lastTs = ts;
            console.log('try to newDifficulty:', (ts - lastRtc), options.retargetTime);
            ...
            console.log('start to set difficulty:', avg, tMax, tMin, client.difficulty, options.minDiff);

            /*
            try to newDifficulty: 90 90
            start to set difficulty: 0.625 19.5 10.5 128 1
            newDiff 512
            */
            ...
            timeBuffer.clear();
            console.log('newDiff', newDiff, ddiff);
